...
from unity import solve_contract as contract, solve_representation as review, solve_state as state
from test_solve_manifest_repair import ManifestStateFixture, output
...
class RejectedEncodingTests(ManifestStateFixture):
    ...
    def test_exact_repair_permission_invalidates_on_each_bound_identity(self):
        ...
        mutations = {
            ...
            "source": lambda value: value["solution_candidates"][self.paper["candidate_id"]].update(sha256="8" * 64),
