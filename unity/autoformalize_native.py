"""Autoformalize-only native inspectors, cached by helper source and Lean toolchain.
...
from . import artifacts, autoformalize_jobs
...
def executable(
    ...
    *,
    ...
    try:
        ...
        cache = root / ".unity" / "bin" / f"autoformalize-{name}"
