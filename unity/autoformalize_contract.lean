/-
AUTOFORMALIZE-only kernel contract and axiom extractor. This is deliberately independent of
...
namespace UnityAutoformalizeContract
...
end UnityAutoformalizeContract
