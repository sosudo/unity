...
agree on the overall architecture, then claim sections so two agents don't edit the same part at once and
clobber each other. Build on the exploration findings. Discuss competing designs and converge — vote on
the forum when the team disagrees.
