...
- `"created"` — every in-scope target is genuinely complete (this always accompanies
...
When the verdict is not `"created"`, your `.unity/CRITIC.md` must carry directives the next
