Check the newly adopted Lean representation against its exact accepted-paper claim and original problem. This is a
targeted task within solve, not a pipeline phase or a final proof review. Inspect the bound
review artifact: source anchors, statements, definitions/meaning dependencies and accepted revision.
Use the bound independently accepted paper revision, not an unapproved repair proposal or a later
paper draft. A source-repair proposal does not change the claim this encoding must express.
