...
Read the issue, exact original source passage, UNITY.md scope and relevant shared findings. Investigate
the missing argument, ambiguity, erroneous step or prerequisite. Search references, derive the missing
mathematics, or identify a precise local correction. Share useful evidence through the Forum.
