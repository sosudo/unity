/-
Autoformalize-only Lake module discovery. Compile once per helper/toolchain revision:
...
namespace UnityAutoformalizeWorkspace
...
end UnityAutoformalizeWorkspace

def main (args : List String) : IO UInt32 := do
  try
    let result ← UnityAutoformalizeWorkspace.discover args
